                     ...
                     <tr v-for="doc in props.documents.data" :key="doc.id" class="hover:bg-[#1f1f1f] transition-colors group">
                         ...
                         <td class="px-6 py-4 text-right">
                             <div class="flex items-center justify-end gap-1">
                                 <button class="p-2 text-gray-500 hover:text-white hover:bg-white/5 rounded-lg transition-all" title="View Document">
                                     <Eye class="w-4 h-4" />
                                 </button>
                                 <button class="p-2 text-gray-500 hover:text-indigo-400 hover:bg-indigo-500/10 rounded-lg transition-all" title="Edit Document">
                                     <Edit2 class="w-4 h-4" />
                                 </button>
